...
class TestScene : public SceneInterface
{
	...
	TestSceneMap map;
	TestSceneMap::entity_type player;
	TestSceneMap::entity_type computer;
	...
	typedef std::pair<TestSceneMap::entity_type,BombInfo> bombInfoPair;
	
	std::list<ExplosionInfo> explosions;
	std::list<bombInfoPair> bombs;
	std::list<TestSceneMap::entity_type> overlappingBombs;
